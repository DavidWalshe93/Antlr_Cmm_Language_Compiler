...
public class LexerTest {
    ...
    private static LexicalInfo[] expectedTokens = new LexicalInfo[]{
            ...
            new LexicalInfo(18, 9, "_var_1", CmmLexer.ID, "2_var_1"),
    ...
    public static void main(String... args) throws Exception {
        ...
        CharStream input = CharStreams.fromFileName("C:\\Users\\David\\Google Drive\\CIT\\Modules\\Programming Langauge Design\\Cmm_Compiler_David_Walshe\\lab_03\\test\\input.txt");
